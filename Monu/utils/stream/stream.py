...
from Monu import Carbon, YouTube, app
from Monu.core.call import Monu
from Monu.misc import db
from Monu.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from Monu.utils.exceptions import AssistantErr
from Monu.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from Monu.utils.inline.playlist import close_markup
from Monu.utils.pastebin import Monubin
from Monu.utils.stream.queue import put_queue, put_queue_index
from Monu.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Monu.force_stop_stream(chat_id)
