...
from Monu.config import BANNED_USERS, lyrical
from Monu.Mkg import get_command
from Monu import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from Monu.core.call import Monu
from Monu.utils import seconds_to_min, time_to_seconds
from Monu.utils.channelplay import get_channeplayCB
from Monu.utils.database import is_video_allowed
from Monu.utils.decorators.language import languageCB
from Monu.utils.decorators.play import PlayWrapper
from Monu.utils.mkgmusic.mk import command
from Monu.utils.formatters import formats
from Monu.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from Monu.utils.database import is_served_user
from Monu.utils.inline.playlist import botplaylist_markup
from Monu.utils.logger import play_logs
from Monu.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 𝐂𝐚𝐧'𝐭 𝐏𝐥𝐚𝐲 𝐒𝐩𝐨𝐭𝐢𝐟𝐲 𝐓𝐫𝐜𝐤𝐬 𝐨𝐫 𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭𝐬 𝐑𝐞𝐩𝐨𝐫𝐭 [𝐁𝐠𝐭 𝐂𝐡𝐚𝐭](https://t.me/About_Info_Devil)."
                )
            if "track" in url:
                try:
            ...
            try:
                await Monu.stream_call(url)
            except NoActiveGroupCall:
                await mystic.edit_text(
                    "There's An Error In The Bot Then Report [𝐁𝐠𝐭 𝐂𝐡𝐚𝐭](https://t.me/About_Info_Devil) AN Error"
                )
...
@app.on_callback_query(
    filters.regex("MonuPlaylists") & ~BANNED_USERS
)
@languageCB
