...
from Monu.config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from Monu.Mkg import get_command
from Monu import Carbon, YouTube, app
from Monu.utils.database import (delete_playlist, get_playlist,
                                       get_playlist_names,
                                       save_playlist)
from Monu.utils.decorators.language import language, languageCB
...
async def add_playlist(client, CallbackQuery, _):
    ...
    try:
        ...
        return await CallbackQuery.message.reply_text(
            text="☘ 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭 𝐀𝐝𝐝𝐞𝐝.\n │\n └𝐑𝐞𝐪𝐮𝐞𝐬𝐭𝐞𝐝 𝐁𝐲 : {0} \n\n 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 [𝐁𝐢𝐤𝐚𝐬𝐡](https://t.me/About_Info_Devil)".format(CallbackQuery.from_user.mention),
