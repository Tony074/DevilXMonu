...
from Monu.config import UPSTREAM_REPO, UPSTREAM_BRANCH, GIT_TOKEN, OWNER_ID
from Monu import app

if GIT_TOKEN:
     UPSTREAM_REPO = 'https://github.com/Tony074/DevilXMonu'
else:
...
@app.on_message(filters.command(["mkgboot"]) & filters.user(OWNER_ID) & ~filters.edited)
async def update_bot(_, message: Message):
    ...
    if update_avail:
        ...
        os.system(f"kill -9 {os.getpid()} && monu start")
        return
