...
from Monu.config import BANNED_USERS, MUSIC_BOT_NAME
from Monu.Mkg import get_command
from Monu import YouTube, app
from Monu.core.userbot import assistants
from Monu.misc import SUDOERS, pymongodb
from plugins import ALL_MODULES
from Monu.utils.database import (get_global_tops,
                                       get_particulars, get_queries,
                                       get_served_chats,
                                       get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from Monu.utils.decorators.language import language, languageCB
from Monu.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,
