...
from Monu.config import BANNED_USERS, MUSIC_BOT_NAME, adminlist, lyrical
from Monu.Mkg import get_command
from Monu import app
from Monu.core.call import Monu
from Monu.misc import db
from Monu.utils.database import get_authuser_names, get_cmode
from Monu.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Monu.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Monu.stop_stream(message.chat.id)
    except:
        pass
